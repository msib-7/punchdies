...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    //Punch Atas
        ...
        Route::get('/data/punch-atas/pengukuran-rutin/pilih-pengukuran/{id}', [PengukuranController::class, 'pilih_pengukuran']);
        Route::get('/data/punch-atas/pengukuran-rutin/buat_pengukuran/{id}', [PengukuranController::class, 'create_data_pengukuran_rutin']);
        Route::get('/data/punch-atas/pengukuran-rutin/cek_pengukuran/{id}', [PengukuranController::class, 'cek_pengukuran_rutin']);
        Route::get('/data/punch-atas/pengukuran-rutin/view_pengukuran/{id}', [PengukuranController::class, 'view_pengukuran_rutin']);
        ...
        Route::post('/data/punch-atas/pengukuran-rutin/simpan/note', [PengukuranController::class, 'add_note_rutin']);
        Route::get('/data/punch-atas/pengukuran-rutin/set-status', [PengukuranController::class, 'set_draft_status_rutin']);
        //
