    ...
    public function run(): void
    {
        ...
        foreach ($roles as $role) {
            foreach ($routes as $routeName => $route) {
                ...
                if (str_starts_with($routeName, 'pnd.pa.') || str_starts_with($routeName, 'pnd.approval.histori.') || $routeName == 'login' || $routeName == 'logout' || $routeName == 'dashboard' || $routeName == 'audit') {
        ...
        foreach ($roles as $role) {
            foreach ($routes as $routeName => $route) {
                // Check if the route prefix is 'pnd'
                if (str_starts_with($routeName, 'pnd.pr.') || str_starts_with($routeName, 'pnd.approval.histori.') || $routeName == 'login' || $routeName == 'logout' || $routeName == 'dashboard' || $routeName == 'audit') {
                    // If the role is Engineering, allow permissions for 'pnd.pa.*', 'login', 'logout', and 'dashboard'
