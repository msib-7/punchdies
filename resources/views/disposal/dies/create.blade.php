                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                   <!--begin::Form-->
                                                    <form class="form" action="{{ route('pnd.request.disposal.store', $labelIdentitas->dies_id) }}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{ $labelIdentitas->dies_id }}">
                                                        <div>
