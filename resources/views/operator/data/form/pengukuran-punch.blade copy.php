                                                                    ...
                                                                    <table style="border: none;">
                                                                        <tbody>
                                                                            <tr style="border: none; height: 30px;">
                                                                                ...
                                                                                <td style="border: none;"
                                                                                    class="fs-5 px-4 my-4">
                                                                                    {{ ucwords($labelPunch->punch_masa_pengukuran) }}</td>
                                                                            </tr>
                                                                            <tr style="border: none; height: 30px;">
                                                                                <td style="border: none;"
                                                                                    class="fs-5 px-4 my-4">
...
<script>
    $(document).ready(function () {
        ...
        //Working Length Awal
            var tr = document.createElement('tr');
            var td = tr.appendChild(document.createElement('td'));
            var wkl_pre = td.appendChild(document.createTextNode("Working Length (AWAL)"));
            td.appendChild(wkl_pre);
            <?php
            $no = 0;
            foreach($draftPengukuran as $data){ ?>
                var td = tr.appendChild(document.createElement('td'));
                var x = td.appendChild(document.createElement('INPUT'));
                x.setAttribute("type", "number");
                x.setAttribute("class", "form-control text-center fw-bold");
                x.setAttribute("name", "wkl_pre[]");
                x.setAttribute("placeholder", "00.00");
        ...
        //Working Length Rutin
            var tr = document.createElement('tr');
            var td = tr.appendChild(document.createElement('td'));
            var wkl = td.appendChild(document.createTextNode("Working Length (RUTIN)"));
            td.appendChild(wkl);
            <?php
            $no = 0;
            foreach($draftPengukuran as $data){ ?>
...
<script>
    ...
    function saveInterval(){
        $.ajax({
                url: "/data/<?= $jenis ?>/pengukuran-rutin/save-interval",
                type: "POST",
                data: $('#form_data_pengukuran').serialize(),
            })
    }
