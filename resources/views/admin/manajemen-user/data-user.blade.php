                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            ...
                                            <input class="form-check-input me-3" name="user_role" type="radio" value="{{ $data->id}}"
                                                id="kt_modal_add_role_option_{{$no}}" />
                                            <!--end::Input-->
                                            <!--begin::Label-->
                                            <label class="form-check-label" for="kt_modal_add_role_option_{{$no}}">
    ...
    <div class="modal fade" id="kt_modal_edit_user" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-5">
                    <!--begin::Form-->
                    <form id="kt_modal_edit_user_form" action="{{route('admin.users.update')}}" method="POST">
                        @csrf
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                            data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto"
