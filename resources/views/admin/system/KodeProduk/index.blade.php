    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Master Kode Produk</li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-400 w-5px h-2px"></span>
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal"
                data-bs-target="#kt_modal_add_user">Create Kode Produk</a>
            <!--end::Primary button-->
        </div>
        <!--end::Actions-->
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{route('admin.system.kodeProduk.delete', $item->id)}}" class="menu-link px-3"
    ...
    <div class="modal-dialog modal-dialog-centered ">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5">
                <!--begin::Form-->
                <form id="kt_modal_add_nm_produk_form" action="{{route('admin.system.kodeProduk.create')}}" method="POST" class="form">
                    @csrf
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-semibold fs-6 mb-2">Nama Mesin</label>
                                <!--end::Label-->
                                <!--begin::Input-->
...
<div class="modal fade" id="kt_modal_edit_kd_produk" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Edit Kode Produk</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body px-5">
                <!--begin::Form-->
                <form id="kt_modal_edit_nm_produk_form" action="{{route('admin.system.kodeProduk.update')}}" method="POST">
                    @csrf
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                        data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto"
                        ...
                        <div class="row">
                            <!--begin::Input group-->
                            <div class="col-12 fv-row mb-7">
                                <input type="hidden" name="id_KodeProduk" id="id_KodeProduk" />
                                <!--begin::Label-->
...
<script>
    ...
    $('body').on('click', '#btn-edit', function () {
        ...
        $.ajax({
            url: "{{route('admin.system.kodeProduk.edit', ':id')}}".replace(':id', edit_id),
            type: "GET",
            cache: false,
