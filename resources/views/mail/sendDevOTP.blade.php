                                                            ...
                                                            <td class="pad">
                                                                <div class="alignment" align="center"
                                                                    ...
                                                                    <div style="max-width: 122px;"><a href="#"
                                                                            ...
                                                                            tabindex="-1"><img
                                                                                src="{{ asset('assets/logo/Kalbe_Farma2.png') }}"
                                                            ...
                                                            <td class="pad" style="width:100%;">
                                                                <div class="alignment" align="center"
                                                                    ...
                                                                    <div style="max-width: 650px;"><img
                                                                            src="{{ asset('assets/misc/Top.jpeg') }}"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            width="650" alt="Image"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Punch & Dies: Request Access Developer Menu</span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Request Access Developer Menu</span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    style="color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:14px;font-weight:600;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        Harap segera lakukan tinjauan pada url berikut
                                                                        <a href="{{ $data['link'] ?? '' }}">{{ $data['link'] ?? '' }}</a>, 
                                                                        pastikan user telah menghubungi anda 
                                                                        sebelum memberikan kode akses Developer Menu, Terima Kasih.
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
