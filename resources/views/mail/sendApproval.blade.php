...
<body style="background-color: #F6F5FF; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #F6F5FF;">
        <tbody>
            <tr>
                <td>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 25px; padding-left: 20px; padding-right: 20px; padding-top: 25px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div class="alignment" align="center"
                                                                    ...
                                                                    <div style="max-width: 122px;"><a href="#"
                                                                            target="_blank" style="outline:none"
                                                                            tabindex="-1"><img
                                                                                src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Kalbe_Farma.svg/1280px-Kalbe_Farma.svg.png"
                                                                                style="display: block; height: auto; border: 0; width: 100%;"
                                                                                width="122" alt="Logo"
                                                                                title="Logo" height="auto"></a></div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="image_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="width:100%;">
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px">
                                                                    <div style="max-width: 650px;"><img
                                                                            src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/556/Top.png"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            width="650" alt="Image"
                                                                            title="Image" height="auto"></div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    ...
                                                    <table class="paragraph_block block-2" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    style="color:#454562;font-family:'Poppins', Arial, Helvetica, sans-serif;font-size:25px;font-weight:700;letter-spacing:1px;line-height:120%;text-align:center;mso-line-height-alt:45.6px;">
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Reminder Approval</span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="paragraph_block block-3" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:25px;padding-left:25px;padding-right:25px;padding-top:50px;">
                                                                <div
                                                                    style="color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:14px;font-weight:600;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                                                                    <p style="margin: 0; word-break: break-word;">Yth
                                                                    </p>
                                                                    <p style="margin: 0; word-break: break-word;">Bapak
                                                                        / Ibu</p>
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        {{ $data['penerima'] }}</p>
                                                                    <p style="margin: 0; word-break: break-word;">
                                                    ...
                                                    <table class="button_block block-4" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div class="alignment" align="center">
                                                                    <a href="{{ $data['link'] ?? '#' }}"
                                                                        style="text-decoration:none;display:inline-block;color:#3d3d3d;background-color:transparent;border-radius:10px;width:auto;border-top:3px dashed #000000;font-weight:700;border-right:3px dashed #000000;border-bottom:3px dashed #000000;border-left:3px dashed #000000;padding-top:5px;padding-bottom:5px;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:17px;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                                        <span
                                                                            style="padding-left:60px;padding-right:60px;font-size:17px;display:inline-block;letter-spacing:normal;"><span
                                                                                style="word-break: break-word; line-height: 34px;">{{ $data['status'] }}</span></span>
                                                                    </a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="paragraph_block block-5" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:10px;padding-left:25px;padding-right:25px;padding-top:35px;">
                                                                <div
                                                                    style="color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:14px;font-weight:600;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                                                                    <p style="margin: 0; word-break: break-word;">Harap
                                                                        segera lakukan tinjauan pada url berikut
                                                                        <a
                                                                            href="{{ $data['link'] ?? '' }}">{{ $data['link'] ?? '' }}</a>
                                                                        untuk langkah selanjutnya, pastikan tidak ada
                                                                        informasi yang salah, Terima kasih
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; border-radius: 0; color: #000000; width: 650px; margin: 0 auto;"
                                        width="650">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="50%"
                                                    ...
                                                    <table class="paragraph_block block-1" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:20px;padding-left:50px;padding-right:20px;">
                                                                <div
                                                                    style="color:#827a7a;direction:ltr;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:9px;font-weight:500;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:10.799999999999999px;">
                                                ...
                                                <td class="column column-2" width="50%"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                                    <table class="paragraph_block block-1 mobile_hide" width="100%"
                                                        border="0" cellpadding="0" cellspacing="0"
                                                        role="presentation"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="width:100%;">
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px">
                                                                    <div style="max-width: 650px;"><img
                                                                            src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/556/Btm.png"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            width="650" alt="Image"
                                                                            title="Image" height="auto"></div>
                                                                </div>
