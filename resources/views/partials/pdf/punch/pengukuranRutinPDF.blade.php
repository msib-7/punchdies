            ...
            <table class="{{ !$loop->last ? 'new-page' : '' }}">
                <thead>
                    <tr>
                        ...
                        <th class="table-header text-center">Working Length <b>(AWAL)</b></th>
                        <th class="table-header text-center">Working Length <b>(RUTIN)</b></th>
                        <th class="table-header text-center">Cup Depth</th>
                        <th class="table-header text-center">Head Configuration</th>
