                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-5">
                                ...
                                <div class="row border-start">
                                    ...
                                    <div class="col-12 my-3">
                                        ...
                                        <div class="btn-group w-100 w-lg-50" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                                            ...
                                            <label class="btn btn-outline btn-color-muted btn-active-success" data-kt-button="true">
                                                <!--begin::Input-->
                                                <input class="btn-check" type="radio" name="method" value="approve"/>
                                                <!--end::Input-->
                                                Approve
                                            </label>
                                            <!--end::Radio-->
                                            ...
                                            <label class="btn btn-outline btn-color-muted btn-active-danger" data-kt-button="true">
                                                <!--begin::Input-->
                                                <input class="btn-check" type="radio" name="method" value="reject"/>
                                                <!--end::Input-->
                                                Reject
                                            </label>
                                            <!--end::Radio-->
                                            ...
                                            <label class="btn btn-outline btn-color-muted btn-active-warning" data-kt-button="true">
                                                <!--begin::Input-->
                                                <input class="btn-check" type="radio" name="method" value="revisi" />
                                                <!--end::Input-->
                                                Revisi
                                            </label>
                                            <!--end::Radio-->
                                    ...
                                    {{-- Catatan --}}
                                    <div class="col-12 my-3">
                                        <div class="row" id="catatanTextarea" style="display: none;">
                                            <div class="col-12"><b>Catatan :</b></div>
                                            <div class="col-12">
                                                <textarea id="catatanTextarea" class="form-control my-3" rows="3"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- Button --}}
                                    <div class="col-12 my-3">
                                        <button id="submitButton" class="btn btn-primary w-100 btn-sm">Submit</button>
                                    </div>
                                </div>
                            </div>
