    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <button class="btn btn-sm fw-bold btn-primary" id="createDies" data-bs-toggle="modal"
                    data-bs-target="#modal_create_data_dies">
                    Create Data Dies
                </button>
            </div>
        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-2">
                            ...
                            <input type="text" id="searchInput" class="form-control" placeholder="Search..."
                                onkeyup="filterCards()" title="Search by any keyword">
                        </div>
                        ...
                        <div class="col-6 col-md-2">
                            ...
                            <input type="text" id="merkFilter" class="form-control" placeholder="Merk..."
                                onkeyup="filterCards()" title="Filter by merk">
                        </div>
                        <div class="col-6 col-md-2">
                        ...
                        <div class="col-6 col-md-2">
                            ...
                            <select id="namaMesinFilter" onchange="filterCards()" data-control="select2"
                                data-dropdown-parent="#collapseOne" data-placeholder="Select a item..."
                            ...
                            <div class="card shadow-sm border-0 rounded-3 h-100">
                                <div class="card-header">
                                    ...
                                    <h3 class="card-title align-items-start flex-column">
                                        <span
                                            class="card-label fw-bold text-gray-800">{{ strtoupper($data->merk) }}</span>
                                    </h3>
                                    <!--end::Title-->
                                    <!--begin::Toolbar-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-column flex-md-row justify-content-between mt-3">
                                        @if ($hasPengukuranAwal)
                                            <!-- Check if there's no pengukuran awal -->
                                            <button class="btn btn-primary mb-2 mb-md-0" id="{{ $data->dies_id }}"
                                                onclick="buatPengukuran(this)">Buat Pengukuran</button>
                                        @endif
                                        <button class="btn btn-secondary" id="{{ $data->dies_id }}"
                                            onclick="pilihPengukuran(this)">
            ...
            <div class="modal-content">
                    ...
                    <div class="col-12">
                        <form id="form_create_dies">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-5">
                                        <label for="exampleFormControlInput1" class="required form-label">Merk
                                            Dies</label>
                                        <input type="text" class="form-control @error('merk') is-invalid @enderror"
                                            placeholder="Masukkan Merk Dies" name="merk" />
                                        @error('merk')
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-6">
                                            <label for="exampleFormControlInput1" class="required form-label">Bulan
                                                Pembuatan</label>
                                            <select class="required form-select" aria-label="Select example"
                                                name="bulan_pembuatan">
                                        ...
                                        <div class="col-6">
                                            <label for="exampleFormControlInput1" class="required form-label">Tahun
                                                Pembuatan</label>
                                            <select class="required form-select" aria-label="Select example"
                                                name="tahun_pembuatan" id="tahun_buat">
                                ...
                                <div class="col-12">
                                    <div class="mb-5">
                                        <label for="exampleFormControlInput1" class="required form-label">Nama Mesin
                                            Cetak</label>
                                        <select name="nama_mesin_cetak" aria-label="Select a Nama Mesin"
                                            data-control="select2" data-dropdown-parent="#modal_create_data_dies"
                                        ...
                                        <div class="col-6">
                                            <div class="mb-5">
                                                <label for="exampleFormControlInput1" class="required form-label">Nama
                                                    Produk</label>
                                                <select name="nama_produk" aria-label="Select a Nama Produk"
                                                    data-control="select2" data-dropdown-parent="#modal_create_data_dies"
                                                    data-placeholder="Select a item..." class="form-select fw-bold">
                                                    <option value="">Select</option>
                                        ...
                                        <div class="col-6">
                                            <div class="mb-5">
                                                <label for="exampleFormControlInput1" class="required form-label">Kode
                                                    Produk</label>
                                                <select name="kode_produk" aria-label="Select a Kode Produk"
                                                    data-control="select2" data-dropdown-parent="#modal_create_data_dies"
                                                    data-placeholder="Select a item..." class="form-select fw-bold">
                                                    <option value="">Select</option>
                                ...
                                <div class="col-12">
                                    <div class="">
                                        <label for="exampleFormControlInput1" class="required form-label">Pilih Line untuk
                                            Dies</label>
                                        <select name="line_id" aria-label="Select a Line" data-control="select2"
                                            data-dropdown-parent="#modal_create_data_dies"
                                            data-placeholder="Select a item..." class="form-select fw-bold">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</ button>
                        <button type="submit" class="btn btn-primary btn-create">Create Dies</button>
                </div>
                </form>
            </div>
        </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-5">
                                        <div class="form-floating">
                                            <select class="form-select" id="pilih_pengukuran" name="pilih_pengukuran"
                    ...
                    <div class="modal-footer">
                        <div class="p-2">
                            <button type="submit" class="btn btn-sm btn-primary"
                                onclick="this.form.submit(); this.disabled = true; this.value='Creating...'">Confirm</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        function filterCards() {
            ...
            const visibleCards = Array.from(cards).filter(card => {
                ...
                const matchesNamaMesin = cardNamaMesin.includes(
                namaMesin); // Check against the selected machine name
                const matchesTanggal = tanggalPengukuran === '' || cardTanggalPengukuran === tanggalPengukuran;
                const matchesLine = line === '' || cardLine === line;

                return matchesSearch && matchesStatus && matchesMerk && matchesNamaMesin && matchesTanggal &&
                    matchesLine;
            });
        ...
        function pilihPengukuran(elem) {
            $.ajax({
                ...
                success: function(masa_pengukuran) {
                    ...
                    $('#form_pilih_pengukuran').attr('action',
                        "{{ route('pnd.pa.dies.cek-pengukuran', ':id') }}".replace(':id', elem.id));
            ...
            $("#form_create_dies").submit(function(e) {
                ...
                requiredFields.forEach(field => {
                    ...
                    if (input.val().trim() === '') {
                        ...
                        input.after(
                        `<div class="invalid-feedback">This field is required.</div>`); // Show error message
                    } else {
